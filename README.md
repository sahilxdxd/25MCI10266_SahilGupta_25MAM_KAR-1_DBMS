...
## Question 1: Write a SQL query to find all unique pairs of employees who report to the same manager.
### Answer:
...
## Question 2: Write an SQL query to find the second highest salary from an Employee table having columns 
### Answer:
